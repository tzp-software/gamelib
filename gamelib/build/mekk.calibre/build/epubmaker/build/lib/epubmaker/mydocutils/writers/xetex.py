...
class Translator (writers.Translator):
    ...
    def visit_section_title (self, node):
        ...
        node.section_command = self.section_commands [eff_level]
        section = node.parent
        ...
        self.cmd ('%%\n\\%s*{' % (node.section_command))

            
    def depart_section_title (self, node):
        self.cmd ('}\n\n')
        if node.section_command == 'chapter':
            self.cmd (r'\vskip-\lastskip\vskip 40pt plus10pt minus10pt')
